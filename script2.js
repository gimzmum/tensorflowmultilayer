...
model.add(tf.layers.dense({inputShape: [1], units: 15, activation: 'relu'}));
...
async function train() {
  ...
  let results = await model.fit(
    ...
    OUTPUTS_TENSOR, {
      // remove as too little data validationSplit: 0.15, // Take aside 15% of the data to use for validation testing.
